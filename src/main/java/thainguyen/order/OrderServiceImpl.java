...
import thainguyen.shipment.GhtkFormDto;
import thainguyen.detailproduct.DetailProductService;
import thainguyen.discount.DiscountService;
...
public class OrderServiceImpl extends GenericServiceImpl<Order>
    ...
    public void cancel(UUID orderId) throws GhtkCreateOrderFailedException {
        ...
        try {
            ...
            HttpEntity<GhtkFormDto> request = new HttpEntity<>(null, headers);
